...
/**
 * Marker interface for PA types that can be preserved as part of a {@link PreservationJob}
 * 
 * @author Tom Bunting
 * 
 */
public interface Preservable {
	...
	/**
	 * Provides a preservable type identifier for this instance.
	 * 
	 * @return a preservable type identifier
	 */
	String getPreservableTypeID();
}
