...
/**
 * Generic PA RuntimeException extension
 * 
 * @author Tom Bunting
 * 
 */
public class PARuntimeException extends RuntimeException {
	...
	public PARuntimeException(final String message, final Throwable cause) {
		super(message, cause);
	}

	public PARuntimeException(final String message) {
		super(message);
	}
