 ...
 * 
 */
public interface RegistryAuthRepository extends JpaRepository<RegistryAuth, String> {
	/* We can define additional repository methods here as and when required */
}
